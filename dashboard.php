...
<br/>
 ...
 <div style="float:right">
   <a href="add.php" class="btn btn-warning"> Add New List </a>
...
<?php
$sql = "SELECT * FROM todolist WHERE user_id='$user_id' ORDER BY id DESC";
$document_get = mysqli_query($conn, $sql);
while($match_value = mysqli_fetch_assoc($document_get))
{
?>
...
<input id="<?php echo $match_value['id']; ?>"  onchange="javascript:getcheck(this)" type="checkbox"
<?php if($match_value['check_value'] == 'true') echo 'checked';  ?>/>
</td>
<td>
<textarea id="<?php echo $match_value['id']; ?>" class="<?php echo $match_value['description']; ?>" onchange="javascript:getText(this)" <?php if($match_value['check_value'] == 'true') { echo 'disabled '; echo ' style="text-decoration:line-through"'; } ?> ><?php echo $match_value['description']; ?></textarea>
</td>
